...
export const LoginBasicDetail = (props) => {
    const {navigation} = props
    const [ isLoading, setIsLoading ] = useState(false);
    const [ basicDetail, setBasicDetail ] = useState<IBasicDetail>({phoneNo: props.route.params.phoneNo, sessionId: props.route.params.session_id});
    ...
    const registerUser = () => {
        ...
        AuthApi.registerUser(basicDetail).then(response=>{
    ...
    return(
        <View overflow={'hidden'} flex={1} bg='#F2F2F2'>
            ...
            <VStack flex={1}>
                <Box flex={1}>
                    <Center>
                        <Heading my='20'>Basic Details</Heading>
                        <Input
                            fontSize={'18'}
                            px='3'
                            mt='5'
                            ...
                            onChangeText={(value) => setBasicDetail({...basicDetail, name: value})}
                            borderRadius={'15'}
                            bg={'#FFFFFF'}
                            w={{
                                base: "60%",
                        ...
                        <Input
                            ...
                            onChangeText={(value) => setBasicDetail({...basicDetail, email: value})}
                            borderRadius={'15'}
                            bg={'#FFFFFF'}
                            w={{
                                base: "60%",
